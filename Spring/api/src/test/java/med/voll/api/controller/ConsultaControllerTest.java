...
class ConsultaControllerTest {
   ...
   /* @Test
    ...
    void agendarEscenario2() throws Exception {
        ...
        var datos = new DatosDetalleConsulta(null,2l,5l,data);
        ...
        var response = mvc.perform(post("/consultas")
                ...
                .content(agendarConsultaJacksonTester.write(new DatosAgendarConsulta(null,2l,5l, data, especialidad)).getJson())
